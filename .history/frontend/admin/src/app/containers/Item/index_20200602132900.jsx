          ...
          {field.value.map((fields, index) => {
            return (
              <div className="spotter-section-field-control-repeater">
                {!index && <button className="spotter-section-field-control-repeater-append spotter-section-field-control-repeater-append__before"></button>}
                <button className="spotter-section-field-control-repeater-append spotter-section-field-control-repeater-append__after"></button>
