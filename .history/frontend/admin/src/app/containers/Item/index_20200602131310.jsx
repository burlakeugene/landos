          ...
          {field.value.map((fields, index) => {
            return (
              <div className="spotter-section-field-control-repeater">
                <button className="spotter-section-field-control-repeater-control-append spotter-section-field-control-repeater-control-append__before"></button>
                <button className="spotter-section-field-control-repeater-control-append spotter-section-field-control-repeater-control-append__after"></button>
